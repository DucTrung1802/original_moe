...
if __name__ == "__main__":
    ...
    trainset_flip = torchvision.datasets.CIFAR10(
        root="./data", train=True, download=True, transform=transform_rotate_train
    )
    # Cluster and targets
    ...
    # Testset negative
    testset_flip = torchvision.datasets.CIFAR10(
        root="./data", train=False, download=True, transform=transform_rotate_test
    )
    ...
    for i in range(5):
        ...
        scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizers[0], T_max=200)
